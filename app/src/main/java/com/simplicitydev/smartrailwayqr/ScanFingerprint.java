...
public class ScanFingerprint extends Activity implements MFS100Event {
    ...
    public void FindFormControls() {
        try {
            ...
            gen_qr_code=findViewById(R.id.genqr);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
        ...
        try {
            switch (v.getId()) {
                case R.id.btnSyncCapture:
                    ...
                    if(lblMessage.getText().toString().equals("Capture Success")){
